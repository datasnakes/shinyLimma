...
ui <- (tagList(
  ...
  navbarPage(
    title = a(href = "http://shanecaldwell.info/shinyLimma/", "Shiny-Limma!"),
    ################################################################
    ...
    tabPanel(
      ...
      sidebarLayout(
        ...
        it and make better preprocessing decisions."),
          br(),
          br(),
          selectInput("exploreSelection",
            label = "Desired Data Visualization",
    ...
    tabPanel(
      ...
      sidebarLayout(
        sidebarPanel(
          ...
          br(),
          br(),
          selectInput("normalizationSelection",
            label = "Choose desired normalization technique...",
            choices = list(
              "No normalization" = 1, "Variance Stabilization Transform" = 2,
          ...
          selectInput("filteringSelection",
            label = "Choose desired filtering level for probes...",
            choices = list(
              "No filtering..." = 1, "Exploratory (10%)" = 0.10,
          ...
          selectInput("ratioSelection",
            label = "What percentage of the samples must meet the filtering criteria?",
            choices = list(
              "None of them" = 1, "Exploratory (25%)" = 0.25, "Standard (15%)" = 0.15,
    ...
    tabPanel(
      ...
      sidebarLayout(
        sidebarPanel(
          ...
          br(),
          br(),
          selectInput("analysisSelection",
            label = "How do you want to look at your results?",
            choices = list(
              "Take your pick!" = 1, "Top Table" = 2,
              "Select a Gene" = 3
            ),
            selected = 1
          ),
          conditionalPanel(
            ...
            selectInput("exportCriteria",
              label = p("Which genes to export"),
        ...
        mainPanel(
          div(
            ...
            textInput("report_title",
              label = h5("Title of Report"),
              value = "Unique title..."
            ),
            textInput("report_author",
              label = h5("Author of the report"),
              value = "Your name here!"
            ),
            selectInput("report_output",
              label = h5("Style of Report to Generate"),
    ...
    ### This works but why###
    bsModal("modalExample", "What's a contrast matrix?", "contrastInfo",
      size = "large",
      HTML(getTutorial())
    )
  )
